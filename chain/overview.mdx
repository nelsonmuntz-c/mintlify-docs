...
XYZ Chain is a Proof of Stake blockchain built with Cosmos SDK v0.53.4 and CosmWasm v0.60.3.
...
XYZ Chain uses CometBFT (formerly Tendermint) for Byzantine Fault Tolerant consensus.
...
XYZ Chain supports CosmWasm smart contracts through the `x/wasm` module.
