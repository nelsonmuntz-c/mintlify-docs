---
title: 'XYZ Docs'
description: 'Welcome to XYZ Chain - A zero-inflation Cosmos SDK blockchain with CosmWasm smart contracts'
---

# Welcome to XYZ Chain

XYZ Chain is a Proof of Stake blockchain built with [Cosmos SDK](https://docs.cosmos.network) designed to receive bridged XYZ tokens from Solana. The chain features **zero inflation** tokenomics and full [CosmWasm](https://cosmwasm.com) smart contract support.
...
<CardGroup cols={2}>
  ...
  <Card title="CosmWasm Contracts" icon="code">
...
| Service | URL |
|---------|-----|
| REST (Cosmos SDK) | `http://67.205.164.156:1317` |
| RPC (Tendermint) | `http://67.205.164.156:26657` |
